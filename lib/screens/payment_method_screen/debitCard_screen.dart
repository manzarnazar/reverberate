...
class _DebitCardState extends State<DebitCard> {
  ...
  double yourDouble = 12.345678; // Replace with your double value
  ...
  placeOrder() async {
    ...
    String formattedamount = widget.amount!.toStringAsFixed(3);
    if (widget.package_id != null) {
      print("objectooo");
      pay(Uri.parse(
          "${AppConfig.BASE_URL}/benefitpay/initiate/${randomString}?amount=${formattedamount}&package_id=${widget.package_id}"));
    } else {
      pay(Uri.parse(
          "${AppConfig.BASE_URL}/benefitpay/initiate/${randomString}?amount=${formattedamount}"));
    }
  }
    ...
    _webViewController
      ...
      ..setNavigationDelegate(
        NavigationDelegate(
          ...
          onPageFinished: (page) {
            print("hello ${page}");
            if (page.contains("/benefitpay/success")) {
              print("payment Done");
              if (widget.package_id != null) {
                ToastComponent.showDialog("Package Subscribed",
              ...
              //                 go_back: false,
              //               )));
            } else if (page.contains("/benefitpay/cancel")) {
