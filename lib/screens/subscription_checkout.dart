...
import 'package:active_ecommerce_flutter/screens/payment_method_screen/creditCard_screen.dart';
import 'package:active_ecommerce_flutter/screens/payment_method_screen/debitCard_screen.dart';
...
class SubscriptionCheckout extends StatefulWidget {
  ...
  @override
  _SubscriptionCheckoutState createState() => _SubscriptionCheckoutState();
}
...
class _SubscriptionCheckoutState extends State<SubscriptionCheckout> {
  ...
  fetchAll() {
    ...
    if (is_logged_in.$ == true) {
      if (widget.paymentFor == PaymentFor.Subscription) {
        _grandTotalValue = widget.rechargeAmount;
        print(_grandTotalValue);

        payment_type =
            widget.paymentFor == PaymentFor.Subscription ? "subscription" : "";
      } else {}
    }
  }
...
// method list
  ...
  fetchList() async {
    var paymentTypeResponseList = await PaymentRepository()
        .getPaymentResponseList(list: widget.list, mode: "subscription");
  ...
  onPressPlaceOrderOrProceed() {
    ...
    // }
      ...
      pay_by_cod();
    } else if (_selected_payment_method == "debitCard") {
      Navigator.push(context, MaterialPageRoute(builder: (context) {
        return DebitCard(
          amount: _grandTotalValue,
          // payment_type: payment_type,
    ...
    } else if (_selected_payment_method == "creditCard") {
      Navigator.push(context, MaterialPageRoute(builder: (context) {
        return CreditCard(
          amount: _grandTotalValue,
          // payment_type: payment_type,
        ...
        child: Row(
          children: [
            ...
            Padding(
              ...
              child: Text(
                  widget.paymentFor == PaymentFor.Subscription
