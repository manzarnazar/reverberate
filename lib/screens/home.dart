...
class _HomeState extends State<Home> with TickerProviderStateMixin {
  ...
  void dispose() {
    SystemChrome.setSystemUIOverlayStyle(SystemUiOverlayStyle(
      statusBarColor: Colors.transparent, // Reset status bar color to default
      statusBarIconBrightness:
          Brightness.dark, // Reset status bar icons to dark
    ));
  ...
  Widget build(BuildContext context) {
    ...
    SystemChrome.setSystemUIOverlayStyle(SystemUiOverlayStyle(
      statusBarColor: Color.fromRGBO(0, 8, 42, 1.0),
  ...
  AppBar buildAppBar(double statusBarHeight, BuildContext context) {
    return AppBar(
      ...
      backgroundColor: Color.fromRGBO(0, 8, 42, 1.0),
      centerTitle: false,
      elevation: 0,
  ...
  buildHomeSearchBox(BuildContext context) {
    return Container(
      height: 36,
      decoration: BoxDecorations.buildBoxSearch(),
      child: Padding(
