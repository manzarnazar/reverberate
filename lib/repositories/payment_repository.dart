...
class PaymentRepository {
  ...
  Future<dynamic> getOrderCreateResponseFromAFS(
      payment_method, double? amount) async {
    String url =
        ("${AppConfig.BASE_URL}/afs?payment_type=cart_payment&email=test@gmail.com&amount=133&combined_order_id=20&package_id=");
